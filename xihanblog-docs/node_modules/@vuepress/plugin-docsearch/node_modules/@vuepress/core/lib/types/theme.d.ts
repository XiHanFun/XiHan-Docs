 ...
 */
export declare type Theme<T extends Record<string, unknown> = Record<never, never>> = Plugin<T, ThemeObject>;
/**
 * Vuepress theme function
 */
export declare type ThemeFunction<T extends Record<string, unknown> = Record<never, never>> = PluginFunction<T, ThemeObject>;
/**
 ...
 */
export declare type ThemeConfig<ThemeLocaleData extends LocaleData = LocaleData> = SiteThemeConfig<ThemeLocaleData>;
